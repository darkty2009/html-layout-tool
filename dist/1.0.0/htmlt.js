...
/**
 * baseline.js 1.0.0 | darkty2009@gmail.com
 * https://github.com/darkty2009/baseline
 */
(function(root, factory) {
    if (typeof define === "function") {
        define("baseline", [], factory);
        ...
        patch.some({
            parse: function() {
                ...
                return function(v) {
                    ...
                    if (matches) {
                        return Date.UTC(matches[1], (matches[2] || 1) - 1, matches[3] || 1, matches[4] - (matches[8] ? matches[9] ? matches[9] + matches[10] : 0 : localHours) || 0, matches[5] - (matches[8] ? matches[9] ? matches[9] + matches[11] : 0 : localMinutes) || 0, matches[6] || 0, ((matches[7] || 0) + "00").substr(0, 3));
                    }
        ...
        patch.one(function(argv) {
            var _Iterator = function() {
                ...
                for (var key in this.source) {
                    if (this.source.hasOwnProperty(key)) this.iterator.push([ key, this.source[key] ]);
                }
...
(function(define) {
    define("const", [ "reg" ], function(require, exports, module) {
        var Reg = require("reg");
        return {
            reg_layout: /<layout[a-zA-Z0-9"'=/.\s,-_\{\}\$\uff01-\uff5e ]*?><\/layout>/gi,
...
(function(define) {
    define("main", [ "const", "reg", "module" ], function(require, exports, module) {
...
(function(define) {
    define("module", [ "const", "reg" ], function(require, exports, module) {
        var const_config = require("const");
...
define("init", [ "baseline", "jquery", "main", "const", "module" ], function(require, exports, module) {
    require("baseline");
    require("jquery");
    require("main");
});
